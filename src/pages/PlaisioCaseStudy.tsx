...
export default function PlaisioCaseStudy({ navigateTo }) {
  useEffect(() => {
    window.scrollTo(0, 0);
  }, []);
      ...
      <main className="pt-32 px-6">
        ...
        >
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-extrabold tracking-tight text-white font-display leading-[1.1]">
            ...
            <br />
            <span className="text-gray-400">The Modular System</span>
          </h1>
        </motion.div>

        {/* Teaser Video (Το ΝΕΟ βίντεο που έστειλες) */}
        <motion.div
          initial={{ opacity: 0, y: 30 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ delay: 0.1 }}
          className="max-w-5xl mx-auto mb-24 relative rounded-[2rem] overflow-hidden shadow-[0_0_80px_rgba(0,255,0,0.1)] border border-gray-800"
        >
          <video
            src="/02 - bfteaser.webm"
            autoPlay
            loop
            muted
            playsInline
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className="max-w-3xl mx-auto border border-gray-800 bg-[#111111] rounded-2xl p-8 md:p-10 text-center mb-24 shadow-2xl"
        >
          <h3 className="text-white text-xl md:text-2xl font-bold mb-4">
            High-Conversion UI/UX at Scale
          </h3>
          <p className="text-gray-400 text-sm md:text-base leading-relaxed">
            We redesigned the digital storefront of Greece's largest technology
            retailer by shifting from static campaigns to a modular design
            system. It handles extreme traffic spikes while maximizing
            conversion rates.
          </p>
        </motion.div>
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className="relative max-w-4xl mx-auto flex flex-col items-center mb-32"
        >
        ...
        >
          <div className="text-center mb-10">
            <p className="text-gray-500 uppercase tracking-widest text-sm font-bold mb-3">
              The Challenge:
            </p>
          ...
          <div className="bg-[#111111] border-l-4 border-green-500 p-8 md:p-10 rounded-r-2xl shadow-xl">
            <p className="text-gray-400 leading-relaxed text-lg mb-6">
              Black Friday at Plaisio handles massive traffic. The core issue
              was finding the balance between aggressive promotional marketing
              and a clean, trustworthy user experience that doesn't overwhelm
              the user.
            </p>
            <div className="p-5 bg-green-500/10 rounded-xl border border-green-500/20 text-green-400 text-sm leading-relaxed">
              <strong className="block mb-2 text-green-300 font-bold">
                The Objective:
              </strong>
              Increase click-through rates by standardizing components while
              maintaining a high-energy visual aesthetic.
            </div>
          </div>
        </motion.section>
        ...
        >
          <h3 className="text-center text-3xl font-bold text-white mb-16 font-display">
            System in Action
          </h3>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6">
            <div className="aspect-[4/3] md:col-span-2 bg-[#111111] border border-gray-800 rounded-2xl flex items-center justify-center hover:border-gray-600 transition-colors overflow-hidden">
              <img
                ...
                alt="Landing Page Elements"
                className="w-full h-full object-cover object-top"
              />
            </div>
            <div className="aspect-[4/3] md:col-span-2 bg-[#111111] border border-gray-800 rounded-2xl flex items-center justify-center hover:border-gray-600 transition-colors overflow-hidden">
              <img
                src="/20241120-electric-scooter-black-friday-slider.jpg"
                alt="Scooter Slider"
                className="w-full h-full object-cover"
              />
            </div>
            ...
            <div className="aspect-[4/3] md:col-span-2 bg-[#111111] border border-gray-800 rounded-2xl flex items-center justify-center hover:border-gray-600 transition-colors overflow-hidden">
              <img
                src="/20241120-urban-glide-e-scooters-black-friday-category-slider.jpg"
                alt="Category Slider"
                className="w-full h-full object-cover"
              />
            </div>
            ...
            <div className="aspect-square bg-[#111111] border border-gray-800 rounded-2xl flex items-center justify-center hover:border-gray-600 transition-colors overflow-hidden">
              <img
                src="/list_banner_mobile(750x410) – 1.jpg"
                alt="List Banner Mobile"
                className="w-full h-full object-cover"
              />
            </div>
          </div>
        ...
        <motion.section
          ...
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          className="max-w-3xl mx-auto text-center mb-16 border-t border-gray-800 pt-24"
        >
          <h3 className="text-2xl font-bold text-white mb-6 font-display">
            Conclusion
          </h3>
          <p className="text-gray-400 leading-relaxed text-lg mb-12">
            By aligning aggressive marketing visuals with a strict, modular
            layout system, we maintained order amidst the chaos. The result was
            a highly scalable, conversion-focused journey.
          </p>
          <button
            onClick={() => navigateTo('home')}
            className="px-10 py-4 bg-white text-black hover:bg-gray-200 rounded-full font-bold transition-all shadow-xl inline-flex items-center gap-2"
          >
